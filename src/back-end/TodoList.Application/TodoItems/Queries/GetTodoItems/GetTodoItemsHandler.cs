...
namespace TodoList.Application.TodoItems.Queries.GetTodoItems
{
    ...
    public sealed class GetTodoItemsHandler(ITodoItemsRepository repository, ILogger<GetTodoItemsHandler> logger) : IRequestHandler<GetTodoItemsQuery, Result<ApplicationError, GetTodoItemsResponse>>
    {
        ...
        public async Task<Result<ApplicationError, GetTodoItemsResponse>> Handle(GetTodoItemsQuery request, CancellationToken cancellationToken)
        {
