class TodoItemStatusMessages {
    ...
    static readonly Error: string = 'We encountered a problem with your todo item.';
    static readonly Refreshed: string = 'Your todo items have been refreshed.';
}

export default TodoItemStatusMessages